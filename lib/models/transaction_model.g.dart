...
TransactionModel _transactionModelDeserialize(
  ...
  object.balance = reader.readDoubleOrNull(offsets[1]);
  object.category = reader.readString(offsets[2]);
  object.id = id;
  object.included = reader.readBool(offsets[3]);
  object.isIncome = reader.readBool(offsets[4]);
  object.merchant = reader.readString(offsets[5]);
  object.smsBody = reader.readStringOrNull(offsets[6]);
...
extension TransactionModelQuerySortBy
  ...
  QueryBuilder<TransactionModel, TransactionModel, QAfterSortBy>
      sortByIncluded() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'included', Sort.asc);
    });
  }
  ...
  QueryBuilder<TransactionModel, TransactionModel, QAfterSortBy>
      sortByIncludedDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'included', Sort.desc);
    });
  }
...
extension TransactionModelQueryWhereDistinct
  ...
  QueryBuilder<TransactionModel, TransactionModel, QDistinct>
      distinctByIncluded() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'included');
    });
  }
  ...
  QueryBuilder<TransactionModel, TransactionModel, QDistinct> distinctBySmsBody(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension TransactionModelQueryProperty
  ...
  QueryBuilder<TransactionModel, double?, QQueryOperations> balanceProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TransactionModel, bool, QQueryOperations> includedProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'included');
    });
  }
  ...
  QueryBuilder<TransactionModel, String, QQueryOperations> merchantProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'merchant');
    });
  }

  QueryBuilder<TransactionModel, String?, QQueryOperations> smsBodyProperty() {
    return QueryBuilder.apply(this, (query) {
